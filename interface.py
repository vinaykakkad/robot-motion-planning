...
ttk.Label(
    window, text="Select the Maximum Row :", font=("Times New Roman", 10)
).grid(column=0, row=5, padx=10, pady=25)

maximumRow = tk.StringVar()
maximumRow = ttk.Combobox(
    window, width=27, textvariable=maximumRow, state="readonly"
)
num = list(range(4, 16))
num.insert(0, "Please select value")
...
ttk.Label(
    window, text="Select the Maximum Column :", font=("Times New Roman", 10)
).grid(column=2, row=5, padx=10, pady=25)
maximumColumn = tk.StringVar()
maximumColumn = ttk.Combobox(
    window, width=27, textvariable=maximumColumn, state="readonly"
)
num = list(range(4, 16))
num.insert(0, "Please select value")
...
ttk.Label(
    window, text="Select the Starting Row :", font=("Times New Roman", 10)
).grid(column=0, row=6, padx=10, pady=25)

startingRow = tk.StringVar()
startingRow = ttk.Combobox(
    window,
    width=27,
    textvariable=startingRow,
    state="readonly",
    postcommand=changeValueSRow,
)
num = []
num.insert(0, "Please select value")
startingRow["values"] = list(num)
...
ttk.Label(
    window, text="Select the Starting Column :", font=("Times New Roman", 10)
).grid(column=2, row=6, padx=10, pady=25)

startingColumn = tk.StringVar()
startingColumn = ttk.Combobox(
    window,
    width=27,
    textvariable=startingColumn,
    state="readonly",
    postcommand=changeValueSCol,
)
num = []
num.insert(0, "Please select value")
startingColumn["values"] = list(num)
...
ttk.Label(
    window, text="Select the Ending Row :", font=("Times New Roman", 10)
).grid(column=0, row=7, padx=10, pady=25)

endingRow = tk.StringVar()
endingRow = ttk.Combobox(
    window,
    width=27,
    textvariable=endingRow,
    state="readonly",
    postcommand=changeValueERow,
)
num = []
num.insert(0, "Please select value")
...
ttk.Label(
    window, text="Select the Ending Column :", font=("Times New Roman", 10)
).grid(column=2, row=7, padx=10, pady=25)

endingColumn = tk.StringVar()
endingColumn = ttk.Combobox(
    window,
    width=27,
    textvariable=endingColumn,
    state="readonly",
    postcommand=changeValueECol,
)
num = []
num.insert(0, "Please select value")
...
ttk.Label(
    window,
    text="Select the Number of Obstacles :",
    font=("Times New Roman", 10),
).grid(column=0, row=8, padx=10, pady=25, columnspan=3)

numberObstacles = tk.StringVar()
numberObstacles = ttk.Combobox(
    window,
    width=27,
    textvariable=numberObstacles,
    state="readonly",
    postcommand=changeNumberofObstacles,
)
num = []
num.insert(0, "Please select value")
numberObstacles["values"] = tuple(num)
...
def validation():
    ...
    if maxCol == "Please select value":
        flag = True
        mb.showinfo(
            "Maximum Column Error", "Please select valid maximum column"
        )
        return
    else:
    ...
    if startCol == "Please select value":
        flag = True
        mb.showinfo(
            "Starting Column Error", "Please select valid starting column"
        )
        return
    else:
    ...
    if num_obstacle_pts == "Please select value":
        flag = True
        mb.showinfo(
            "Obstacles Error", "Please select valid number of obstacles"
        )
        return
    else:
    ...
    if (startRow, startCol) == (goalRow, goalCol):
        ...
        mb.showinfo(
            "Point Error",
            "Starting Point and ending Point Same. Please enter valid points",
        )
        return
    if flag == False:
        print(values)
...
B = tk.Button(
    window,
    text="Start Roboust Motion Planning",
    command=validation,
    bg="#89cfef",
